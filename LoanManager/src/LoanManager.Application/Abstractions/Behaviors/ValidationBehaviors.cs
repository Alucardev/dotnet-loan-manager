...
namespace LoanManager.Application.Abstractions.Behaviors;
...
where TRequest : IBaseCommand
{
    ...
    Console.WriteLine("Validadores utilizados:");
    foreach (var validator in _validators)
    {
        ...
        if(!_validators.Any())
        {
            Console.WriteLine("No hay validadores");
            return await next();
        }

        Console.WriteLine("Hay validadores");
